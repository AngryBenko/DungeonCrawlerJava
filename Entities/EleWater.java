...
public class EleWater extends Entity {
    ...
    public EleWater() {
        super(name, maxHealth, lightAttack, heavyAttack, speed, defense, new JLabel(new ImageIcon(EleWater.class.getClassLoader().getResource("res/entity/enemies/" + name + ".gif"))));
    }
}
