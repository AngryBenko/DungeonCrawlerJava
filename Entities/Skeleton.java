...
public class Skeleton extends Entity {
    ...
    public Skeleton() {
        super(name, maxHealth, lightAttack, heavyAttack, speed, defense, new JLabel(new ImageIcon(Skeleton.class.getClassLoader().getResource("res/entity/enemies/" + name + ".gif"))));
    }
}
