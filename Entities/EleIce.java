...
public class EleIce extends Entity {
    ...
    public EleIce() {
        super(name, maxHealth, lightAttack, heavyAttack, speed, defense, new JLabel(new ImageIcon(EleIce.class.getClassLoader().getResource("res/entity/enemies/" + name + ".gif"))));
    }
}
